...
namespace Abp.ZeroCore.SampleApp.Core
{
    ...
    {
        public DbContext DbContext => GetDbContent();
        ...
        protected DbContext GetDbContent() => ((Abp.ZeroCore.SampleApp.Repositorys.TenantRepository)TenantRepository).GetDbContext();
    }
