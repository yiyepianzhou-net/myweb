...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abp.ZeroCore.SampleApp.Core.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.ZeroCore.SampleApp.Core.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.ZeroCore.SampleApp.Core.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Abp.ZeroCore.SampleApp.Core.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Abp.ZeroCore.SampleApp.Core.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.ZeroCore.SampleApp.Core.Role", b =>
                {
                    b.HasOne("Abp.ZeroCore.SampleApp.Core.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Abp.ZeroCore.SampleApp.Core.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Abp.ZeroCore.SampleApp.Core.User", "LastModifierUser")
                        .WithMany()
